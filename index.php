...
<html>
<head>
<title>Launch Page: Dungeon Crawl Classics Halfling Character Generator Version 3</title>
...
<body>
	...
	<section>
		...
		<h1><img src="images/title.png" alt="Dungeon Crawl Classics Halfling Character Generator Version 3" class="image" /></h1>
        ...
        <p><a href="https://www.oldschooladventures.org/dcc/halfling/"  class="text_link" target="_blank"><span class="bold">Dwarves, Warriors & Mighty Deeds: A DCC Fan Site</span></a></p>

        <p><a href="https://www.tasaka-games.com/dcc/more/classes/halfling/"  class="text_link" target="_blank"><span class="bold">Fantastic Adventures and the Distgruntled Gong Farmer: A DCC Adventure Module</span></a></p>

        <br/>
        <br/>
            
  
        <form action="" id ="HalflingFormV3"  target="_blank" method="post">
    ...
    <div class="content9">
         ...
         <div id="characterNameV3">
            ...
            <span id="characterHalflingNameV3"> <input type="text" name="theCharacterName" value="" class="nameBox"></span>
        ...
        <br/>
            ...
            <span class="formIputDescription">Armour:</span>	
			  <select id="armourV3" name="theArmour" class="alignmentBox">			
				...
				<option value="2" selected>Leather armour</option>
    ...
    <br/>
        ...
        $("#generate_charactersWarriorV3").click(function(){
         ...
         $("#HalflingFormV3").attr('action', "character3/dccHalfling.php");
